...
open class PanModalPresentationController: UIPresentationController {
    ...
    private lazy var backgroundView: DimmedView = {
        let view: DimmedView
        if let color = presentable?.dimmedColor {
    ...
    override public func viewWillTransition(to size: CGSize, with coordinator: UIViewControllerTransitionCoordinator) {
        ...
        coordinator.animate(alongsideTransition: { [weak self] _ in
            ...
            if presentable.shouldRoundCorners {
...
private extension PanModalPresentationController {
    ...
    func configureViewLayout() {
        ...
        guard let layoutPresentable = presentedViewController as? UIViewController & PanModalPresentable
            else { return }
