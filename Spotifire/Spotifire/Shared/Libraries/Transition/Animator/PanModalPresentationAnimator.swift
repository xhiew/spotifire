...
public class PanModalPresentationAnimator: NSObject {
     ...
     */
    private func panModalLayoutType(from context: UIViewControllerContextTransitioning) -> (UIViewController & PanModalPresentable)? {
        switch transitionStyle {
        case .presentation:
            return context.viewController(forKey: .to) as? UIViewController & PanModalPresentable
        case .dismissal:
            return context.viewController(forKey: .from) as? UIViewController & PanModalPresentable
        }
    }
